...
(defun dcoverage-default-find-cov-file ()
  "Default way to find coverage file: find project root, then go to 'client/build/reports/clover/clover.xml'."
  (concat (file-name-as-directory (dcoverage-find-project-root)) "client/build/reports/clover/clover.xml"))
